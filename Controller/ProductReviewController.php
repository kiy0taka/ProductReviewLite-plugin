...
class ProductReviewController extends AbstractController
{
     ...
     * @Inject(ProductReviewRepository::class)
     */
    private $productReviewRepository;

    /**
     * @Route(path="/products/review/{id}", name="plugin_product_review")
     * @Template("ProductReview/Resource/template/default/Product/review.twig")
     */
     ...
     * @Template("ProductReview/Resource/template/default/Product/review_complete.twig")
     */
